...
areg child_sex treat##i.p05  i.bord  if  rural==1 & mtempo==1,  cl( state_yob) absorb(UID )
...
areg child_sex treat##i.p05##fg  i.bord if  rural==1 & bord>=2 & mtempo==1,  cl( state_yob) absorb(UID )
eststo r1f
