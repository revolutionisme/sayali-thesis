...
reghdfe fg v133 i.v130 i.sh36 v138 v151 v152  s190rs v119 v120 v121 v122 v123 v124 v125 strend  if  rural==1 & b2>=2000 & b2 <=2005 & bord==1 & treat!=.  & bpl==0,  cl( v024) absorb( b2  v024)
eststo fg1
*title(`"Test of balance by the sex of the first born"')
coefplot (fg1,  drop(strend)), levels( 95) vertical yline(0) xlabel(,angle(90)) msymbol(S) coeflabels(v133="Mother's education" v138 = "no of women in hh" v151= "sex of hh head" v152="age of hh head" s190rs="wealth index" v119="elec" v120="radio" v121="tv" v122="refri" v123="cycle" v124="scooter" v125="truck" ) 
...
**Robustness
*state cl
reghdfe child_sex treat##i.b2 strend  if  rural==1 & mtempo==1,  cl( v024) absorb(UID b2 bord v024)
eststo robs
