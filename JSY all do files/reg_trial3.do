...
use "C:\Users\ssj18\Documents\DHS\trial",clear
drop D
...
tab state
tab state,nol
synth_runner sex_ratio uc_prop scst_prop obc_prop bpl_prop medu(1986(1)2004) mage(1986(1)2004) ///
sex_ratio(1986) sex_ratio(1992) sex_ratio(1998) sex_ratio(2003), d(D) trends training_propr(`=13/18')
pval_graphs
