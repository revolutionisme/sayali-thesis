...
save "C:\Users\ssj18\Documents\DHS\trial_r",replace
...
synth_runner cigsale beer(1984(1)1987) lnincome(1972(1)///
1987) retprice age15to24, d(D) trends training_propr
(`=13/18')*/


use "C:\Users\ssj18\Documents\DHS\trial_r",clear
drop if b2<=1995
egen state = group(v024),label /*1 is treatment*/
...
drop if state==6 /*drop chandigard because too many missing vals*/
drop if b2<=1987
tsset state b2
...
tab state
tab state,nol
synth_runner sex_ratio uc_prop scst_prop obc_prop bpl_prop medu(1995(1)2004) mage(1995(1)2004) ///
